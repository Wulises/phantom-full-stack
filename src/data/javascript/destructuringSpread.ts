export const destructuringAndSpread = [
  {
    ...
    description: 'Extrae propiedades de un objeto en variables individuales de forma concisa.',
    code: `const persona = { nombre: "Haru", edad: 25 };
const { nombre, edad } = persona;
console.log(nombre); // "Haru"
console.log(edad);   // 25`,
    tip: 'Útil cuando necesitas acceder a múltiples propiedades rápidamente.',
    extra: '🌸 Haru dice: “Desestructurar es como conocerte mejor, parte por parte.”'
  },
  {
    title: 'Desestructuración de arrays',
    description: 'Extrae valores de un array en variables individuales usando su posición.',
    code: `const colores = ["rojo", "verde", "azul"];
const [primero, segundo] = colores;
console.log(primero); // "rojo"
console.log(segundo); // "verde"`,
    tip: 'Ideal para acceder rápido a elementos en arrays conocidos.',
    extra: '🎓 Makoto aclara: “En los arrays, cada posición tiene su razón de ser.”'
  },
  {
    title: 'Rest en desestructuración de objetos',
    description: 'Puedes capturar el "resto" de propiedades en una nueva variable.',
...
console.log(resto);  // { id: 1, rol: "admin" }`,
    ...
    extra: '🌸 Haru reflexiona: “A veces lo que queda es justo lo que necesitas.”'
  },
  {
    title: 'Rest en desestructuración de arrays',
    description: 'Puedes capturar el resto de elementos de un array después de extraer los primeros.',
...
console.log(otros);   // [2, 3, 4, 5]`,
    ...
    extra: '🎭 Sumire comenta: “El inicio es importante, pero lo que viene después también brilla.”'
  },
  {
...
console.log(combinado); // [1, 2, 3, 4]`,
    ...
    extra: '🎓 Makoto dice: “Combinar sin alterar... esa es la elegancia de JavaScript.”'
  }
]
