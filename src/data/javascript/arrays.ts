...
export const arraysJs = [
  {
    ...
    description:
      'Aprende cómo crear arrays y acceder a sus elementos usando índices.',
...
console.log(frutas[0]) // manzana`,
  ...
  },
  {
    ...
    description:
      'Manipula los valores de un array agregando o quitando elementos.',
...
console.log(numeros)`,
  ...
  },
  {
    ...
    code: `const países = ['México', 'Inglaterra', 'Canadá']

países.forEach(país => {
  console.log('Me voy a, ' + país)
})

const mayusculas = países.map(n => n.toUpperCase())
...
console.log(b)`,
    ...
    extra:
      'Kasumi dice: “Extiende tus posibilidades con el operador de expansión.”',
  },
  {
    title: 'Buscar y filtrar en arrays',
    description:
      'Utiliza `filter`, `find`, `includes` y más para buscar elementos.',
    code: `const animales = ['Perro', 'Gato', 'Búho']

const Gato = animales.find(a => a === 'Gato')
const conB = animales.filter(a => a.startsWith('B'))
const tieneAPerro = animales.includes('Perro')

console.log(Gato, conB, tieneAPerro)`,
    tip: '`find` te da el primero que coincida, `filter` todos.',
    extra:
      'Haru susurra: “Buscar en un array es como encontrar afinidad en los corazones.”',
  },
]
