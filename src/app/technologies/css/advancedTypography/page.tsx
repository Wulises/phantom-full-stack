...
import { advancedTypographyCSS } from '@/data/css/advancedTypography'
import SubtemaItem from '@/components/subTopicItems'
import { motion } from 'framer-motion'
import Link from 'next/link'

export default function AdvancedTypographyCSS() {
  return (
    <main className='main-h-screen bg-gradient-to-br from-velvet to-royal px-5 py-10'>
      ...
      >
        {advancedTypographyCSS.map((item, i) => (
          <motion.div
            key={i}
            variants={{
