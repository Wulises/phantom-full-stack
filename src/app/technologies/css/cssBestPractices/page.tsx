...
import { cssBestPractices } from '@/data/css/cssBestPractices'
import SubtemaItem from '@/components/subTopicItems'
import { motion } from 'framer-motion'
import Link from 'next/link'

export default function CssBestPractices() {
  return (
    <main className='main-h-screen bg-gradient-to-br from-velvet to-royal px-5 py-10'>
      ...
      >
        Organización y buenas prácticas en CSS
      </motion.h1>
