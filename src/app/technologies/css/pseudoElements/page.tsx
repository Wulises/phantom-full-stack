...
import { pseudoElementsCSS } from '@/data/css/pseudoElements'
import SubtemaItem from '@/components/subTopicItems'
import { motion } from 'framer-motion'
import Link from 'next/link'

export default function PseudoElementsCSS() {
  return (
    <main className='main-h-screen bg-gradient-to-br from-velvet to-royal px-5 py-10'>
      ...
      >
        Pseudo-clases y pseudoelementos en CSS
      </motion.h1>
