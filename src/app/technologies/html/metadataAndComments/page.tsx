'use client';
import { metadataAndCommentsHTML } from '@/data/html/metadataAndComments'
...
export default function TEAMOSUMIRE() {
  ...
  return (
    ...
    <main className='main-h-screen bg-gradient-to-br from velvet to-royal px-5 py-10'>
      ...
      >
        Comentarios y Metadatos en HTML
      </motion.h1>

      <p className='text-center text-sm text-white/60 italic mb-10'>
         Lo que el navegador ve, pero el usuario no.
      </p>
      ...
      >
        {metadataAndCommentsHTML.map((item, i) => (
