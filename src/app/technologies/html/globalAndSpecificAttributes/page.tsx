'use client';
import { globalAndSpecificAttributesHTML } from '@/data/html/globalAndSpecificAttributes'
...
export default function TEAMOSUMIRE() {
  ...
  return (
    ...
    <main className='main-h-screen bg-gradient-to-br from velvet to-royal px-5 py-10'>
      ...
      >
        Atributos Globales y Específicos en HTML
      </motion.h1>

      <p className='text-center text-sm text-white/60 italic mb-10'>
         Personalizando etiquetas y ampliando sus funcionalidades.
      </p>
      ...
      >
        {globalAndSpecificAttributesHTML.map((item, i) => (
