'use client';
import { nativeResponsivenessHTML } from '@/data/html/nativeResponsivenessHTML'
...
export default function TEAMOSUMIRE() {
  ...
  return (
    ...
    <main className='main-h-screen bg-gradient-to-br from velvet to-royal px-5 py-10'>
      ...
      >
        Responsividad nativa en HTML
      </motion.h1>

      <p className='text-center text-sm text-white/60 italic mb-10'>
        Aprende a hacer que tus páginas web se adapten a diferentes tamaños de pantalla usando solo HTML.
      </p>
      ...
      >
        {nativeResponsivenessHTML.map((item, i) => (
