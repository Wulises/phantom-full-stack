'use client';
import { accessibilityHTML } from '@/data/html/accessibilityHTML'
...
export default function TEAMOSUMIRE() {
  ...
  return (
    ...
    <main className='main-h-screen bg-gradient-to-br from velvet to-royal px-5 py-10'>
      ...
      >
        Accesibilidad básica en HTML (con ARIA)
      </motion.h1>

      <p className='text-center text-sm text-white/60 italic mb-10'>
        Mejora la accesibilidad de tus páginas web para todos los usuarios, incluyendo aquellos con discapacidades.
      </p>
