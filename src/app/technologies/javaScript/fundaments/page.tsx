...
import { fundamentsJS } from '@/data/javascript/fundaments'
        ...
        <main className='main-h-screen bg-gradient-to-br from velvet to-royal px-5 py-10'>
            ...
            >
                ...
                <p className='text-center text-sm text-white/60 italic mb-10'> 
                    Breve introducción a los conceptos básicos de JavaScript, el lenguaje de programación esencial para el desarrollo web.
                </p>
